...
def freq_table(a_list):
    dict_frequency_value = {}
    for freq in a_list:
        if freq in dict_frequency_value:
            dict_frequency_value[freq] +=1
        else:
            dict_frequency_value[freq] = 1
    return dict_frequency_value 
...
def mean(data_set,index):
    extract_values = extract(data_set,index)
    mean_value = find_sum(extract_values) / find_length(extract_values)
    return mean_value
